...
#else
// 2GB
constexpr size_t EvaluateTableSize = 0x80000000LL;
#endif

using EvaluateHashEntry = EvalSum;
struct EvaluateHashTable : HashTable<EvaluateHashEntry, EvaluateTableSize / sizeof(EvaluateHashEntry)> {};

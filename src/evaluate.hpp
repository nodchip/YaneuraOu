        ...
        while (itoBB.isNot0()) {
          ...
          while (jtoBB_tmp.isNot0()) {
            ...
            const int distance = itodistance + jtodistance - 1;
            {
              ...
              if (jtuple < ituple) {
                std::swap(std::get<0>(ituple), std::get<0>(jtuple));
                std::swap(std::get<1>(ituple), std::get<1>(jtuple));
                std::swap(std::get<2>(ituple), std::get<2>(jtuple));
...
#ifndef KPP_PADDING0
#define KPP_PADDING0 6
#endif
#ifndef KPP_PADDING1
#define KPP_PADDING1 7
#endif

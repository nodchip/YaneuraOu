...
void TimeManagement::init(LimitsType& limits, Color us, int ply)
{
    int minThinkingTime = USI::Options[OptionNames::MINIMUM_THINKING_TIME];
    int moveOverhead = USI::Options[OptionNames::MOVE_OVERHEAD];
    int slowMover = USI::Options[OptionNames::SLOW_MOVER];
    int npmsec = USI::Options[OptionNames::NODESTIME];

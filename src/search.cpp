      ...
      if (5 <= depth && abs(rootMoves[pvIdx].prevScore_) < ScoreKnownWin) {
        ...
        if (depth > 16) {
          static constexpr double WEIGHTS[] = {
            -0.04464747756719589200,
            -0.03359148651361465500,
            0.17587646842002869000,
            -0.15552490949630737000,
            0.01979406364262104000,
            0.02462165057659149200,
            -0.14555312693119049000,
            0.14947798848152161000,
            0.05499494075775146500,
            -0.04580324515700340300,
            0.47766503691673279000,
            -0.65216398239135742000,
            -0.07008492201566696200,
            0.16753590106964111000,
            0.24161686003208160000,
            0.84709352254867554000,
          };
          static constexpr int NUMBER_OF_VARIABLES = sizeof(WEIGHTS) / sizeof(WEIGHTS[0]);
          double sum = 0.04465883225202560400;

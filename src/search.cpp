      ...
      if (5 <= depth && abs(rootMoves[pvIdx].prevScore_) < ScoreKnownWin) {
        ...
        if (depth > 16) {
          static constexpr double WEIGHTS[] = {
            -0.02219688706099987000,
            0.01559108868241310100,
            -0.06524216383695602400,
            0.05532985180616378800,
            0.03022789768874645200,
            -0.04351023584604263300,
            -0.02669638767838478100,
            0.06031746417284011800,
            -0.06290027499198913600,
            0.13316552340984344000,
            -0.09545060247182846100,
            0.00314726890064775940,
            -0.14710156619548798000,
            0.00257116882130503650,
            0.17156821489334106000,
            0.99981039762496948000,
          };
          static constexpr int NUMBER_OF_VARIABLES = sizeof(WEIGHTS) / sizeof(WEIGHTS[0]);
          double sum = 0.00590254878625273700;

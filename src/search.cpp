      ...
      if (5 <= depth && abs(rootMoves[pvIdx].prevScore_) < ScoreKnownWin) {
        ...
        if (depth > 16) {
          static constexpr double WEIGHTS[] = {
            -0.00669443653896451000,
            -0.01486520469188690200,
            -0.01632059738039970400,
            0.03144989162683486900,
            -0.04971841350197792100,
            0.02213968895375728600,
            -0.03169073164463043200,
            0.05731108039617538500,
            -0.02108272165060043300,
            0.03161529079079628000,
            -0.05681988224387168900,
            -0.03845341503620147700,
            -0.05645265430212020900,
            0.04233819246292114300,
            0.16518978774547577000,
            0.95119059085845947000,
          };
          static constexpr int NUMBER_OF_VARIABLES = sizeof(WEIGHTS) / sizeof(WEIGHTS[0]);
          double sum = -0.00224457844160497190;

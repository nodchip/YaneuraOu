      ...
      if (5 <= depth && abs(rootMoves[pvIdx].prevScore_) < ScoreKnownWin) {
        ...
        if (depth > 16) {
          static const double WEIGHTS[] = {
            ...
            0.07308277487754821800,
            -0.12985931336879730000,
            -0.08498086780309677100,
            -0.01719436980783939400,
            0.09958682209253311200,
            0.19262959063053131000,
            -0.14843271672725677000,
            -0.12952126562595367000,
            -0.10212583839893341000,
            -0.07724326848983764600,
            0.31069847941398621000,

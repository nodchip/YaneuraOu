      ...
      if (5 <= depth && abs(rootMoves[pvIdx].prevScore_) < ScoreKnownWin) {
        ...
        if (depth > 16) {
          static constexpr double WEIGHTS[] = {
            -0.00640014996544011321,
            -0.01458671875994784796,
            -0.01697698210652398565,
            0.03382571153810549902,
            -0.05299370808996382853,
            0.02761893198645909778,
            -0.03770652239901569475,
            0.05970569996422357695,
            -0.01199906347676354089,
            0.01564940616290215816,
            -0.03948933041512872610,
            -0.05320046185551751544,
            -0.05006157359981418947,
            0.06569115232250129222,
            0.12767374346021609366,
            0.96224133721375892936,
          };
          static constexpr int NUMBER_OF_VARIABLES = sizeof(WEIGHTS) / sizeof(WEIGHTS[0]);
          double sum = -0.00000069579188979385;

...
def function(args):
  ...
  popenargs = [
    ...
    'SEARCH_RAZORING_DEPTH=' + str(int(args[1])),
    'SEARCH_RAZORING_MARGIN_SLOPE=' + str(int(args[2])),
    'SEARCH_RAZORING_MARGIN_INTERCEPT=' + str(int(args[3])),
    'SEARCH_FUTILITY_MARGIN_DEPTH_THRESHOLD=' + str(int(args[4])),
    ...
    'SEARCH_NULL_MOVE_MARGIN=' + str(int(args[12])),
    'SEARCH_NULL_MOVE_NULL_SCORE_DEPTH_THRESHOLD=' + str(int(args[13])),
    'SEARCH_NULL_FAIL_LOW_SCORE_DEPTH_THRESHOLD=' + str(int(args[14])),
    'SEARCH_PROBCUT_DEPTH_THRESHOLD=' + str(int(args[15])),
    'SEARCH_PROBCUT_RBETA_SCORE_DELTA=' + str(int(args[16])),
    'SEARCH_PROBCUT_RBETA_DEPTH_DELTA=' + str(int(args[17])),
    'SEARCH_INTERNAL_ITERATIVE_DEEPENING_PV_NODE_DEPTH_THRESHOLD=' + str(int(args[18])),
    'SEARCH_INTERNAL_ITERATIVE_DEEPENING_NON_PV_NODE_DEPTH_THRESHOLD=' + str(int(args[19])),
    'SEARCH_INTERNAL_ITERATIVE_DEEPENING_SCORE_MARGIN=' + str(int(args[20])),
    'SEARCH_INTERNAL_ITERATIVE_DEEPENING_PV_NODE_DEPTH_DELTA=' + str(int(args[21])),
    'SEARCH_INTERNAL_ITERATIVE_DEEPENING_NON_PV_DEPTH_SCALE=' + str(int(args[22])),
    'SEARCH_SINGULAR_EXTENSION_DEPTH_THRESHOLD=' + str(int(args[23])),
    'SEARCH_SINGULAR_EXTENSION_TTE_DEPTH_THRESHOLD=' + str(int(args[24])),
    'SEARCH_SINGULAR_EXTENSION_NULL_WINDOW_SEARCH_DEPTH_SCALE=' + str(int(args[25])),
    'SEARCH_FUTILITY_MOVE_COUNTS_SCALE=' + str(int(args[26])),
    'SEARCH_FUTILITY_MOVE_COUNTS_POWER=' + str(int(args[27])),
    'SEARCH_FUTILITY_MOVE_COUNTS_INTERCEPT=' + str(int(args[28])),
    'SEARCH_FUTILITY_PRUNING_PV_REDUCTION_SLOPE=' + str(int(args[29])),
    'SEARCH_FUTILITY_PRUNING_PV_REDUCTION_INTERCEPT=' + str(int(args[30])),
    'SEARCH_FUTILITY_PRUNING_NON_PV_REDUCTION_SLOPE=' + str(int(args[31])),
    'SEARCH_FUTILITY_PRUNING_NON_PV_REDUCTION_INTERCEPT=' + str(int(args[32])),
    'SEARCH_FUTILITY_PRUNING_SCORE_GAIN_SLOPE=' + str(int(args[33])),
